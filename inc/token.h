...
da_new_static(token_builtins, const char *, &_idx_cmp_str, "+", "-", "*", "/", "=", ">", ">=", "<", "<=", "!", "!=", "dump", "dup", "drop", "swap", "over", "rot", "nip", "tuck", "if", "end", "else", "while", "do", "let", "set", "mem", "load", "l8", "l16", "l32", "l64", "syscall3", "macro", "include");
